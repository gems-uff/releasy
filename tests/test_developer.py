...
def test_release_authors():
    ...
    assert len(project.releases[5].developers.authors) == 2
    ...
    assert project.releases[5].developers.authors[1] == dev.charlie
...
def test_release_committers():
    ...
    assert len(project.releases[5].developers.committers) == 3
    ...
    assert project.releases[5].developers.committers[1] == dev.charlie
    assert project.releases[5].developers.committers[2] == dev.bob
...
def test_release_newcomers():
    ...
    assert len(project.releases[5].developers.newcomers) == 1
    assert len(project.releases[6].developers.newcomers) == 0
    ...
    assert project.releases[5].developers.newcomers[0] == dev.charlie

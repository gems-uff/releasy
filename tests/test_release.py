...
class describe_release_version():
    ...
    def it_has_type(self, release_versions: List[ReleaseVersion]):
    ...
    def it_handle_incomplete_versions(self):
        v1 = ReleaseVersion("1")
...
class describe_release_set():
    def it_contains_releases(self):
        releases = ReleaseSet()
